...
class Userlink(dotbot.Plugin):
    '''
    Symbolically links dotfiles.
    '''

    _directive = 'userlink'
    _user = str.lower(os.environ['USER'])
    ...
    def _process_links(self, links):
        ...
        for destination, source in links.items():
            ...
            #if a user-specific file exists (bashrc_johndoe), use this.
            if os.path.isfile(path + "_" + self._user):
                path = path + "_" + self._user 
            if create:
    ...
    def _link(self, source, link_name, relative):
        ...
        # destination directory
            ...
            try:
                ...
                self._log.lowinfo('Creating userlink %s -> %s' % (link_name, source))
                success = True
